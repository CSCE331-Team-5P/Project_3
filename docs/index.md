...
### Kiosk
#### API
- [Chat API Documentation](./kiosk/api/chat.md)
- [Database API Documentation](./kiosk/api/connectDB.md)
- [Weather API Documentation](./kiosk/api/weather.md)

#### Components
- [Chatbot Component](./kiosk/components/Chatbot.md)
- [Drink Card Component](./kiosk/components/DrinkCard.md)
- [Drink Selection Component](./kiosk/components/DrinkSelection.md)
- [Gallery Component](./kiosk/components/Gallery.md)
- [Global State Provider](./kiosk/components/GlobalStateProvider.md)
- [Kiosk Footer Component](./kiosk/components/KioskFooter.md)
- [Menu Item Card Component](./kiosk/components/MenuItemCard.md)
- [Navbar Component](./kiosk/components/Navbar.md)
- [Order Popover Component](./kiosk/components/OrderPopover.md)

#### Context
- [Magnifier Context](./kiosk/context/MagnifierContext.md)

#### Pages
- [Menu Items Page](./kiosk/pages/menuItems.md)
- [Drinks Page](./kiosk/pages/drinks.md)
- [Checkout Page](./kiosk/pages/checkout.md)
- [Extras Page](./kiosk/pages/extras.md)
- [Home Page](./kiosk/pages/home.md)
- [Employee Login Page](./kiosk/pages/employeeLogin.md)
